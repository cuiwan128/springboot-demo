...
public class JackController {
    ...
    public @ResponseBody Integer queryArea(ConsultConfigArea area) {
        return areaService.saveArea(area);
    }

    @RequestMapping("/cache1")
    public @ResponseBody String cache1(String param ) {
        return areaService.queryData(param);
    }

    @RequestMapping("/cache2")
    public @ResponseBody String cache2(String param ) {
        return areaService.putCache(param);
    }
